/* Configuração v2.0 — persistência online (Google Sheets + Login Google)
   Estes valores NÃO são secretos de forma forte (o app é público). A segurança real
   é o login Google + allowlist validada no servidor (Apps Script). */
